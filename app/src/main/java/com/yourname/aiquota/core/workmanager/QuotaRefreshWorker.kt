...
import com.yourname.aiquota.core.notification.QuotaNotificationService
import com.yourname.aiquota.core.security.EncryptedPrefsManager
import com.yourname.aiquota.core.tile.QuotaTileService
import com.yourname.aiquota.di.ClaudeRepository
import com.yourname.aiquota.di.CodexRepository
import com.yourname.aiquota.di.GeminiRepository
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            ...
            val successfulQuotas = quotas.mapNotNull { result ->
                when (result) {
                    is com.yourname.aiquota.core.domain.model.Result.Success -> result.value
                    is com.yourname.aiquota.core.domain.model.Result.Failure -> null
                }
            }
